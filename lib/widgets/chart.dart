...
class Chart extends StatelessWidget {
  ...
  List<Map<String, Object>> get groupedTransactionValues {
    ...
    return List.generate(7, (index) {
      ...
      var totalSum =
          0.0; //suma total de gastos del dia, sino se inicializa se debe especificar el tipo de dato (double totalSum)
      ...
      return {
        "dia": DateFormat.E().format(weekDay).substring(0,
            1), //para obtener en texto el dia de la semana, substring para solo obtener la primera letra
        "monto": totalSum,
      };
    }).reversed.toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
        ...
        child: Padding(
          //se usa para poder agregar padding al Row, ya que desde Row no se puede
          padding: EdgeInsets.all(10),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: groupedTransactionValues.map((data) {
              //el metodo GET retorna una Lista, pero para poder mostar en pantalla necesitamos Widgets
              return Flexible(
                //para gestionar espaciado dentro de los elementos del Row
                fit: FlexFit
                    .tight, //se forza a un Widget hijo a respetar su espacio correspondiente sn tomar espacio de los demas hijos
                child: ChartBar(
                    data["dia"],
                    data["monto"],
                    totalSpending == 0.0
                        ...
                        : (data["monto"] as double) /
                            totalSpending), //se debe evitar division entre 0
              );
            }).toList(),
          ),
        ));
